...
public class DashboardPerpus extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(DashboardPerpus.class.getName());
    ...
    private void initComponents() {
        ...
        MenuName.setText("Haii!!! Selamat Datang Anggota");
        ...
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 90, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new DashboardPerpus().setVisible(true));
    }
